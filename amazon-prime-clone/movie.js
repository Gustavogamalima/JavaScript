...
fetch('https://api.themoviedb.org/3/movie/popular?api_key=59e68837c4463302c863684b9d02356b&language=en-US&page=1')
...
fetch('https://api.themoviedb.org/3/movie/popular?api_key=59e68837c4463302c863684b9d02356b&language=en-US&page=2')
.then(response=> response.json())
.then(data=>{
    data.results.map((i,j)=>{
